  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ padding: '20px 20px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
        <Link href={`/assets/${id}`} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: 36, height: 36, borderRadius: '50%', background: '#f4f6f9', border: '1px solid var(--ds-border)', textDecoration: 'none' }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--ds-text)', margin: 0 }}>{t('service.title')}</h1>
        </div>
      ...
      <div style={{ padding: '20px 20px 0' }}>
        ...
        {schedules && schedules.length > 0 ? (
          ...
          <div style={{ background: 'var(--ds-surface)', borderRadius: 12, padding: '20px 16px', border: '1px dashed #c8d4e8', textAlign: 'center' }}>
...
function StatCard({ label, value, icon }: { label: string; value: string; icon: React.ReactNode }) {
  return (
    <div style={{ background: 'var(--ds-surface)', borderRadius: 12, padding: '12px 14px', border: '1px solid var(--ds-border)' }}>
      ...
      <p style={{ fontSize: 16, fontWeight: 700, color: 'var(--ds-text)', margin: 0, fontFamily: 'Arial, sans-serif' }}>{value}</p>
    </div>
  )
}
