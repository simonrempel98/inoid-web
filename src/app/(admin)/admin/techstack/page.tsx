        ...
        <div style={{ ...S.card, marginTop: 4 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '120px 1fr', gap: '4px 16px' }}>
            {[
              ...
              ['030', 'INOai Crawler-Admin: inoai_crawlers Tabelle (URL, Name, Lang, Status), inoai_crawl_jobs (log, stats, resume_state, diff)'],
              ...
              ['033', 'Crawler-Resilienz: failedPages JSONB-Feld + 5 User-Agent-Rotation (kein PDF-Parsing)'],
